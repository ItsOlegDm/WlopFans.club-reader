...
<body class="contentsbody">
  <div class="github-button">
    <a class="github-button" href="https://github.com/itsolegdm/WlopFans.club-reader" data-size="large"
      data-color-scheme="no-preference: dark; light: dark; dark: dark;"
      aria-label="Star itsolegdm/WlopFans.club-reader on GitHub">GitHub</a>
  </div>
      ...
      <div class="menu">
        <div class="acc">
          ...
          <div class="panel">
            <!-- <div class="content"> -->
            <div class="menuitem">
              <a href="../reader/?ch=10-1" class="menuitem"><span>10.1</span>
                <ion-icon name="chevron-forward-outline"></ion-icon>
              </a>
            </div>
            <div class="menuitem">
              <a href="../reader/?ch=10-2" class="menuitem"><span>10.2</span>
                <ion-icon name="chevron-forward-outline"></ion-icon>
              </a>
            </div>
            <div class="menuitem">
              <a href="../reader/?ch=10-3" class="menuitem"><span>10.3</span>
                <ion-icon name="chevron-forward-outline"></ion-icon>
              </a>
            </div>
            <div class="menuitem">
              <a href="../reader/?ch=10-4" class="menuitem"><span>10.4</span>
                <ion-icon name="chevron-forward-outline"></ion-icon>
              </a>
            </div>
            <!-- </div> -->
          ...
          <div class="panel">
            <div class="menuitem">
              <a href="../reader/?ch=11-1" class="menuitem"><span>11.1</span>
                <ion-icon name="chevron-forward-outline"></ion-icon>
              </a>
            </div>
            <div class="menuitem">
              <a href="../reader/?ch=11-2" class="menuitem"><span>11.2</span>
                <ion-icon name="chevron-forward-outline"></ion-icon>
              </a>
            </div>
          </div>
